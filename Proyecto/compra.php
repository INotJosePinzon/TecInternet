...
<body>
  ...
  <div class="contenidoo">
    <div class="card-group ">
      ...
      <div class="card">
        <label class="col-sm-6 col-form-label " id="detalleproducto">DETALLES DE PRODUCTO</label>
      </div>
      <div class="card">
        <form>
          <div class="form-group row">
            <label for="inputfecha" class="col-sm-6 col-form-label">Precio</label>
          </div>
          <div class="form-group row">
            <label for="inputfecha" class="col-sm-4 col-form-label">Cantidad</label>
          ...
          <div class="form-group row">
            <button type="button" class="btn btn-boton-pago">Eliminar producto</button>
          </div>
          <div class="form-group row">
            <button type="button" class="btn btn-boton-pago" onclick="window.location.href='pago.php'">Realizar pago</button>
          </div>
        </form>
      </div>
    </div>
